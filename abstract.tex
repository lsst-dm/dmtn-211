In this paper we introduce {\ttfamily faro}, a framework for automatically and efficiently computing scientific performance metrics on the LSST data products for units of data of varying granularity, ranging from single-detector to full-survey summary statistics.\begin{abstract}

The Vera C. Rubin Observatory will advance nearly every area of astronomy over the next decade with its unique wide-fast-deep multi-color imaging survey, the Legacy Survey of Space and Time (LSST).
